...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # it wouldn't? in the third example, + would have returned nil, but * is just an empty set?
  end
  ...
  # 
  # Why?
  # Because there's no cap on the number of characters they can return?
  ...
  # Character classes are all self-contained so it'd be like James Gray, Dana Gray, Summer Gray, whereas alternations allow for reusability of characters?
